...
from src.dataset.augment.rand_augment import rand_augment_transform
...
import src.dataset.augment.functional as FF
...
class Compose(object):
    ...
    def __call__(self, clip): # 给 clip 加上所有 transform 方式
