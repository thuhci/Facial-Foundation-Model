...
def ImageProcessing_RT():
    ...
    if not os.path.exists(os.path.join(out_root, "Label/train")):
        os.makedirs(os.path.join(out_root, "Label/train"))

    # Prepare outfiles' path of label
    label_outpath1 = os.path.join(out_root, "Label/train", "train1.label")
    label_outpath2 = os.path.join(out_root, "Label/train", "train2.label")
    label_outpath3 = os.path.join(out_root, "Label/train", "train3.label")
    label_outpath4 = os.path.join(out_root, "Label/train", "valid.label")
