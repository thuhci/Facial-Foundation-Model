...
root = "/root/shared/emotion_dataset/MAFW/data/frames/"
out_root = "../Gaze360/mafw_normalized"
csv_root = "/home/qzk/Facial-Foundation-Model/saved/data/mafw/single"
out_txt_root = "../Gaze360/mafw_normalized/lbls"
...
def ImageProcessing_Gaze360(split):
    ...
    for i, line in enumerate(lines):
        ...
        all_imgs = os.listdir(os.path.join(root, folder_name))

        for img_path in all_imgs:
            file_name = os.path.join(root, folder_name, img_path)
    ...
    out_txt_file = os.path.join(out_txt_root, f"{split}_test.txt")
...
if __name__ == "__main__":
    for split in ["split01", "split02", "split03", "split04", "split05"]:
