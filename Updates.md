...
```bash
torchrun --nproc_per_node=4 --master_port=29501 run_finetuning_with_yacs.py --config configs/dfew_finetune.yaml --output_dir ./output/new_tlora/dfew_basedOnGaze0-3
```
